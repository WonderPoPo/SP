//
//  TenantChatViewController.swift
//  EstateApp
//
...
class TenantChatCell_Oth : UITableViewCell{
    @IBOutlet weak var message: UILabel!
    @IBOutlet weak var date: UILabel!
    
}
class TenantChatCell_Self : UITableViewCell{
...
class TenantChatViewController : UIViewController,UITableViewDelegate , UITableViewDataSource,UITextFieldDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if (ChatList[indexPath.row].sender == "Self"){
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "TenantChatCell_Self", for: indexPath) as! TenantChatCell_Self
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "TenantChatCell_Oth", for: indexPath) as! TenantChatCell_Oth
