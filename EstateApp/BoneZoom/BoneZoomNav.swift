...
class BoneZoomNav: UIView {
    ...
    convenience init() {
        ...
        self.backgroundColor = BoneZoom.black(alpha: 1.0)
    ...
    lazy var closeBtn: UIButton = {
        ...
        btn.setImage(UIImage(named: "IconBoneZoom.bundle/close"), for: UIControl.State.normal)
        btn.tag = 0
        return btn
    }()
    ...
    lazy var saveBtn: UIButton = {
        ...
        let btn = UIButton(frame: CGRect(origin: origin, size: CGSize(width: 30, height: 30)))
        btn.setImage(UIImage(named: "IconBoneZoom.bundle/save"), for: UIControl.State.normal)
        btn.tag = 1
        return btn
    }()
